//! PSM Player Core - Video Player Library for Purple Squirrel Media
//!
...
pub use branding::{PsmColors, PsmTheme, JsTheme, CssVariables};
...
pub fn init() {
    tracing::info!(version = VERSION, "PSM Player Core initialized");
}
