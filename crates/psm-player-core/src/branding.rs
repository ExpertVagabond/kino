//! PSM Branding - Official Purple Squirrel Media color palette
//!
//! This module provides the single source of truth for all PSM branding colors.
//! Use these constants across all player implementations (WASM, native, CLI).
//!
//! # Usage
//!
//! ```rust
//! use psm_player_core::branding::{PsmColors, PsmTheme};
//!
...
/// Official PSM color palette
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PsmColors {
...
impl CssVariables {
    /// Generate CSS custom properties for the PSM theme
...
/// Complete PSM theme configuration
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PsmTheme {
    /// Color palette
    pub colors: PsmColors,
...
impl Default for PsmTheme {
    fn default() -> Self {
        Self {
            colors: PsmColors::default(),
            border_radius: 8,
            show_watermark: true,
