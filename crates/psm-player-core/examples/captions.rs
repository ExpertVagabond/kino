...
//!
//! Run with: cargo run -p psm-player-core --example captions

use psm_player_core::captions::{WebVttParser, SrtParser, cues_at_time, srt_to_vtt};

fn main() {
    println!("PSM Player Core - Caption Parsing Example");
    println!("==========================================\n");
