...
//!
//! ```rust,no_run
//! use psm_player_frequency::solana::{SolanaFingerprintClient, FingerprintConfig};
//!
//! #[tokio::main]
...
/// Program ID for the PSM Fingerprint program (placeholder - replace with deployed address)
