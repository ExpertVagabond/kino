...
//!
//! ```javascript
//! import { PsmFrequencyAnalyzer } from '@purplesquirrel/player-wasm';
//!
//! const analyzer = new PsmFrequencyAnalyzer(2048);
//!
...
#[wasm_bindgen]
pub struct PsmFrequencyAnalyzer {
    fft_size: usize,
    analyzer: FftAnalyzer,
}

#[wasm_bindgen]
impl PsmFrequencyAnalyzer {
...
#[wasm_bindgen]
pub struct PsmFingerprinter {
    fft_size: usize,
    hop_size: usize,
}

#[wasm_bindgen]
impl PsmFingerprinter {
...
impl Default for PsmFingerprinter {
    fn default() -> Self {
        Self::new()
    }
}
...
#[wasm_bindgen]
pub struct PsmStreamingAnalyzer {
    fft_size: usize,
    buffer: Vec<f32>,
    analyzer: FftAnalyzer,
    sample_rate: u32,
