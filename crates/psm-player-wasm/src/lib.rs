//! PSM Player WASM - WebAssembly Video Player Library
//!
...
//!
//! ```javascript
//! import init, { PsmAbrController, PsmBranding } from '@purplesquirrel/player-wasm';
//!
//! await init();
//! const abr = new PsmAbrController();
//! ```
...
pub use abr_controller::PsmAbrController;
pub use buffer_controller::PsmBufferController;
pub use analytics::PsmAnalytics;
pub use branding::PsmBranding;
pub use frequency::{
...
pub fn init() {
    ...
    web_sys::console::log_1(&"[PSM Player WASM] Initialized".into());
}
