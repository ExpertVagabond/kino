//! Python bindings for Kino frequency analysis.
//!
...
/// Kino Frequency Analysis Python Module
#[pymodule]
fn kino_frequency(m: &Bound<'_, PyModule>) -> PyResult<()> {
