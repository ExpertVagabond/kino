...
try:
    ...
    print("psm_frequency not installed. Install with: pip install kino-frequency")
    PSM_AVAILABLE = False
...
def psm_analysis_demo():
    """Demonstrate Kino frequency analysis features."""
...
if __name__ == '__main__':
    ...
    print("  2. psm_analysis_demo()       - Kino frequency analysis")
