...
import type { PsmPlayerRef, PlayerState, QoeMetrics } from './types';

interface UsePsmPlayerOptions {
  autoPlay?: boolean;
}

interface UsePsmPlayerReturn {
  ref: React.RefObject<PsmPlayerRef>;
...
export function usePsmPlayer(options: UsePsmPlayerOptions = {}): UsePsmPlayerReturn {
  const ref = useRef<PsmPlayerRef>(null);
